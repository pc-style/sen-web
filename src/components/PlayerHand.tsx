...
export const PlayerHand: React.FC<PlayerHandProps> = ({
  ...
  return (
    <div
      className={cn(
        'rounded-lg border-2 p-0.5 transition-all duration-300 sm:p-1 md:p-2 lg:p-3',
        isCurrentPlayer &&
          gamePhase !== 'round_end' &&
          gamePhase !== 'game_over'
    ...
    >
      <h3
        className={cn(
          'mb-0.5 text-center font-heading text-xs font-semibold sm:mb-1 sm:text-sm md:text-base',
      ...
      <div className={cn('flex justify-center gap-0.5 sm:gap-1 md:gap-2')}>
