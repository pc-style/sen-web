...
const soundFiles = {
  ...
  click:
    'https://assets.mixkit.co/sfx/preview/mixkit-interface-device-click-2577.mp3',
  ...
  pobudka:
    'https://assets.mixkit.co/sfx/preview/mixkit-game-show-wrong-answer-buzz-950.mp3',
};

export type SoundType = keyof typeof soundFiles;

// Preload sounds
const sounds: { [key in SoundType]?: Howl } = Object.entries(soundFiles).reduce(
  (acc, [key, src]) => {
